...
public class UserController {
    ...
    public ResponseEntity<?> getMe(HttpServletRequest request) {
        try {
            ...
            int status = e.getMessage().equals("Unauthorized") || e.getMessage().equals("Invalid token") ? 401 : 400;
    ...
    public ResponseEntity<?> getInvites(HttpServletRequest request) {
        try {
            ...
            List<Map<String, Object>> inviteList = invites.stream().map(inv -> {
                ...
                map.put("organizationName", org != null ? org.getName() : "Unknown");
                map.put("invitedBy", inviter != null ? inviter.getEmail() : "Unknown");
                map.put("status", inv.getStatus());
                map.put("createdAt", inv.getCreatedAt() != null ? inv.getCreatedAt().toString()
